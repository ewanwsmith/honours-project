...
push!(c_data, (("2020-07-20"),
    ...
    ((count(i -> (i > 0), week20.S1_seropositive)) / length(week20.S1_seropositive)),
    (count(i -> (i > 0), week20.RBD_seropositive)),
    ((count(i -> (i > 0), week20.RBD_seropositive)) / length(week20.RBD_seropositive)),
    )) 
...
push!(c_data, (("2020-07-27"),
    ...
    ((count(i -> (i > 0), week21.S1_seropositive)) / length(week21.S1_seropositive)),
    (count(i -> (i > 0), week21.RBD_seropositive)),
    ((count(i -> (i > 0), week21.RBD_seropositive)) / length(week21.RBD_seropositive)),
    ))
...
push!(c_data, (("2020-08-03"),
    ...
    ((count(i -> (i > 0), week22.S1_seropositive)) / length(week22.S1_seropositive)),
    (count(i -> (i > 0), week22.RBD_seropositive)),
    ((count(i -> (i > 0), week22.RBD_seropositive)) / length(week22.RBD_seropositive)),
    ))   
...
push!(c_data, (("2020-08-10"),
    ...
    ((count(i -> (i > 0), week23.S1_seropositive)) / length(week23.S1_seropositive)),
    (count(i -> (i > 0), week23.RBD_seropositive)),
    ((count(i -> (i > 0), week23.RBD_seropositive)) / length(week23.RBD_seropositive)),
    )) 
...
push!(c_data, (("2020-08-17"),
    ...
    ((count(i -> (i > 0), week24.S1_seropositive)) / length(week24.S1_seropositive)),
    (count(i -> (i > 0), week24.RBD_seropositive)),
    ((count(i -> (i > 0), week24.RBD_seropositive)) / length(week24.RBD_seropositive)),
    )) 
...
push!(c_data, (("2020-08-24"),
    ...
    ((count(i -> (i > 0), week25.S1_seropositive)) / length(week25.S1_seropositive)),
    (count(i -> (i > 0), week25.RBD_seropositive)),
    ((count(i -> (i > 0), week25.RBD_seropositive)) / length(week25.RBD_seropositive)),
    ))     
...
push!(c_data, (("2020-08-31"),
    ...
    ((count(i -> (i > 0), week26.S1_seropositive)) / length(week26.S1_seropositive)),
    (count(i -> (i > 0), week26.RBD_seropositive)),
    ((count(i -> (i > 0), week26.RBD_seropositive)) / length(week26.RBD_seropositive)),
    ))   
...
push!(c_data, (("2020-09-07"),
    ...
    ((count(i -> (i > 0), week27.S1_seropositive)) / length(week27.S1_seropositive)),
    (count(i -> (i > 0), week27.RBD_seropositive)),
    ((count(i -> (i > 0), week27.RBD_seropositive)) / length(week27.RBD_seropositive)),
    ))  
...
push!(c_data, (("2020-09-14"),
    ...
    ((count(i -> (i > 0), week28.S1_seropositive)) / length(week28.S1_seropositive)),
    (count(i -> (i > 0), week28.RBD_seropositive)),
    ((count(i -> (i > 0), week28.RBD_seropositive)) / length(week28.RBD_seropositive)),
    ))     
...
push!(c_data, (("2020-09-21"),
    ...
    ((count(i -> (i > 0), week29.S1_seropositive)) / length(week29.S1_seropositive)),
    (count(i -> (i > 0), week29.RBD_seropositive)),
    ((count(i -> (i > 0), week29.RBD_seropositive)) / length(week29.RBD_seropositive)),
    ))     
...
push!(c_data, (("2020-09-28"),
    ...
    ((count(i -> (i > 0), week30.S1_seropositive)) / length(week30.S1_seropositive)),
    (count(i -> (i > 0), week30.RBD_seropositive)),
    ((count(i -> (i > 0), week30.RBD_seropositive)) / length(week30.RBD_seropositive)),
    ))   
...
push!(c_data, (("2020-10-05"),
    ...
    ((count(i -> (i > 0), week31.S1_seropositive)) / length(week31.S1_seropositive)),
    (count(i -> (i > 0), week31.RBD_seropositive)),
    ((count(i -> (i > 0), week31.RBD_seropositive)) / length(week31.RBD_seropositive)),
    ))  
...
push!(c_data, (("2020-10-12"),
    ...
    ((count(i -> (i > 0), week32.S1_seropositive)) / length(week32.S1_seropositive)),
    (count(i -> (i > 0), week32.RBD_seropositive)),
    ((count(i -> (i > 0), week32.RBD_seropositive)) / length(week32.RBD_seropositive)),
    ))    
...
push!(c_data, (("2020-10-19"),
    ...
    ((count(i -> (i > 0), week33.S1_seropositive)) / length(week33.S1_seropositive)),
    (count(i -> (i > 0), week33.RBD_seropositive)),
    ((count(i -> (i > 0), week33.RBD_seropositive)) / length(week33.RBD_seropositive)),
    ))                                                                                                                                                                                                                                                                                                                          
...
push!(c_data, (("2020-10-26"),
    ...
    ((count(i -> (i > 0), week34.S1_seropositive)) / length(week34.S1_seropositive)),
    (count(i -> (i > 0), week34.RBD_seropositive)),
    ((count(i -> (i > 0), week34.RBD_seropositive)) / length(week34.RBD_seropositive)),
    )) 
...
push!(c_data, (("2020-11-02"),
    ...
    ((count(i -> (i > 0), week35.S1_seropositive)) / length(week35.S1_seropositive)),
    (count(i -> (i > 0), week35.RBD_seropositive)),
    ((count(i -> (i > 0), week35.RBD_seropositive)) / length(week35.RBD_seropositive)),
    ))   
...
push!(c_data, (("2020-11-09"),
    ...
    ((count(i -> (i > 0), week36.S1_seropositive)) / length(week36.S1_seropositive)),
    (count(i -> (i > 0), week36.RBD_seropositive)),
    ((count(i -> (i > 0), week36.RBD_seropositive)) / length(week36.RBD_seropositive)),
    ))  
...
push!(c_data, (("2020-11-16"),
    ...
    ((count(i -> (i > 0), week37.S1_seropositive)) / length(week37.S1_seropositive)),
    (count(i -> (i > 0), week37.RBD_seropositive)),
    ((count(i -> (i > 0), week37.RBD_seropositive)) / length(week37.RBD_seropositive)),
    ))  
...
push!(c_data, (("2020-11-23"),
    ...
    ((count(i -> (i > 0), week38.S1_seropositive)) / length(week38.S1_seropositive)),
    (count(i -> (i > 0), week38.RBD_seropositive)),
    ((count(i -> (i > 0), week38.RBD_seropositive)) / length(week38.RBD_seropositive)),
    )) 
...
push!(c_data, (("2020-11-30"),
    ...
    ((count(i -> (i > 0), week39.S1_seropositive)) / length(week39.S1_seropositive)),
    (count(i -> (i > 0), week39.RBD_seropositive)),
    ((count(i -> (i > 0), week39.RBD_seropositive)) / length(week39.RBD_seropositive)),
    )) 
...
push!(c_data, (("2020-12-07"),
    ...
    ((count(i -> (i > 0), week40.S1_seropositive)) / length(week40.S1_seropositive)),
    (count(i -> (i > 0), week40.RBD_seropositive)),
    ((count(i -> (i > 0), week40.RBD_seropositive)) / length(week40.RBD_seropositive)),
    )) 
...
push!(c_data, (("2020-12-14"),
    ...
    ((count(i -> (i > 0), week41.S1_seropositive)) / length(week41.S1_seropositive)),
    (count(i -> (i > 0), week41.RBD_seropositive)),
    ((count(i -> (i > 0), week41.RBD_seropositive)) / length(week41.RBD_seropositive)),
    )) 
...
push!(c_data, (("2020-12-21"),
    ...
    ((count(i -> (i > 0), week42.S1_seropositive)) / length(week42.S1_seropositive)),
    (count(i -> (i > 0), week42.RBD_seropositive)),
    ((count(i -> (i > 0), week42.RBD_seropositive)) / length(week42.RBD_seropositive)),
    )) 
...
push!(c_data, (("2020-12-28"),
    ...
    ((count(i -> (i > 0), week43.S1_seropositive)) / length(week43.S1_seropositive)),
    (count(i -> (i > 0), week43.RBD_seropositive)),
    ((count(i -> (i > 0), week43.RBD_seropositive)) / length(week43.RBD_seropositive)),
    )) 
...
push!(c_data, (("2021-01-04"),
    ...
    ((count(i -> (i > 0), week44.S1_seropositive)) / length(week44.S1_seropositive)),
    (count(i -> (i > 0), week44.RBD_seropositive)),
    ((count(i -> (i > 0), week44.RBD_seropositive)) / length(week44.RBD_seropositive)),
    ))
...
push!(c_data, (("2021-01-11"),
    ...
    ((count(i -> (i > 0), week45.S1_seropositive)) / length(week45.S1_seropositive)),
    (count(i -> (i > 0), week45.RBD_seropositive)),
    ((count(i -> (i > 0), week45.RBD_seropositive)) / length(week45.RBD_seropositive)),
    ))
